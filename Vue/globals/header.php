  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="index.php?page=Accueil">Francais</a></li>
        <li><a href="indexenglish.php?page=Accueil">Anglais</a></li>
        <li><a href="#contact">Espagnol</a></li>
          ...
          <?php if (isConnected()) : ?>
              <li>
                  <a> <strong>bienvenue <?php echo $_SESSION["utilisateur"]["login"]; ?></strong>
                  </a>
              </li>
